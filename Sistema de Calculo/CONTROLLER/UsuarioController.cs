...
namespace Sistema_de_Calculo.CONTROLADOR
{
    ...
    public class UsuarioController
    {
            ...
            string nombre, string correo, string password, string rol = "usuario")
        {
            ...
            var lista = Repositorio.Cargar<Usuario>(ARCHIVO);
        ...
        public (bool ok, Usuario? usuario, string msg) IniciarSesion(string correo, string password)
        {
            var lista = Repositorio.Cargar<Usuario>(ARCHIVO);
        ...
        public List<Usuario> ObtenerTodos() =>
            Repositorio.Cargar<Usuario>(ARCHIVO);
